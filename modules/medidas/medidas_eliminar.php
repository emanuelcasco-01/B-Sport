...
if (empty($id_unidad)) {
    echo json_encode(['status' => false, 'msg' => 'ID de medida no proporcionado']);
    exit;
}
...
try {
    ...
    $response['msg'] = 'Error de integridad: Esta medida tiene registros asociados y no puede ser eliminada.';
}
