// ============================================
// SCRIPT PARA GESTIÓN DE CATEGORÍAS
// ============================================
$(document).ready(function() {
    ...
    const reporteTitulo = "REPORTE DE CATEGORIAS";
    ...
    $("#formCategoria").on("submit", function(e) {
        ...
        const urlDestino = (id === "") 
                ? "../../modules/categorias/categorias_guardar.php" 
                : "../../modules/categorias/categorias_actualizar.php";
    ...
    $('#tblCategorias').on('click', '.btnEditarCategoria', function() {
        const d = $(this).data();
        ...
        $("#estado").val(d.estado);
        $("#modalTitulo").html('<i class="bi bi-pencil-square me-2" style="color: var(--color-yellow);"></i>Actualizar Categoría: ' + d.nombre);
...
function prepararNuevo() {
    $("#formCategoria")[0].reset();
    $("#id_categoria").val("");
    $("#modalTitulo").html('<i class="bi bi-collection" style="color: var(--color-yellow);"></i>Registrar Nueva Categoría');
}

function eliminarCategoria(id, user) {
    if (typeof alertify === 'undefined') {
    ...
    alertify.confirm(
        ...
        `¿Está seguro de que desea eliminar la categoría <strong>${user}</strong>?`,
        function() {
            ejecutarEliminacion(id);
        },
        function() {
...
function ejecutarEliminacion(id) {
    $.ajax({
        url: "../../modules/categorias/categorias_eliminar.php",
        type: "POST",
