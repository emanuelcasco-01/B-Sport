...
$menu = [
    ...
    "Compras" => [
        ...
        "items" => [
            ...
            ["nombre" => "Proveedores", "ruta" => "views/proveedores/proveedores.php"],
            ...
            ["nombre" => "Categorías", "ruta" => "views/categorias/categorias.php"],
            ["nombre" => "Marcas", "ruta" => "views/marca/marca.php"],
            ["nombre" => "IVA", "ruta" => "views/iva/iva.php"],
            ["nombre" => "Medidas", "ruta" => "views/medidas/medidas.php"]
        ]
    ],
